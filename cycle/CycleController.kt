...
class CycleController(private val context: Context): CrudHelper(context) {
    ...
    var currCycleExistsInDb: Boolean = true // false if startMeal1(), which INSERTs cycles, was never called after app install;
...
//            // on AppState.fasting, test to ensure that the fasting timer is now counting from newPrevCycle.fastingStart
//        }
//        // in the cycle, which just became Prev (if exists), make fastingStart = null
//    } // deletePrevCycle()
    /***********************************************************************************************************************/
...
//    } // cancelOmad()
    ...
    fun startMeal1() {
        ...
        AppState.meal1 = true
        AppPrefs.put(PrefKey.LAST_APP_STATE_SET_BY_USER, AppState.MEAL_1, context) // for MainActivity.onResumeCheckInactivity()
    } // startMeal1()
    /***********************************************************************************************************************/
    ...
    fun startMeal2() {
        ...
        update(currCycle)
        AppState.meal2 = true
        AppPrefs.put(PrefKey.LAST_APP_STATE_SET_BY_USER, AppState.MEAL_2, context) // for MainActivity.onResumeCheckInactivity()
    } // startMeal2()
    /***********************************************************************************************************************/
